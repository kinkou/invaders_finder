...
The presented solution is by no means optimal in terms of efficiency or memory consumption. I believe there are more clever solutions to the problem of the space invader detection, however I will give my thoughts on a possible alternative approach.
